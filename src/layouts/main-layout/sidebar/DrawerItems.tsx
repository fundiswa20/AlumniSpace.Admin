...
import LogoImg from 'assets/images/tut.png';
    ...
    <>
      ...
      >
        <ButtonBase component={Link} href="/" disableRipple>
          <Image src={LogoImg} alt="logo" height={64} width={214} sx={{ mr: 1 }} />
          {/* <Typography variant="h5" color="text.disabled" fontWeight={600} letterSpacing={1}>
            Alumni Space
          </Typography> */}
        </ButtonBase>
      </Stack>
